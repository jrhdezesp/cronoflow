...
<div class="pos-shell">
  <section class="pos-card">
    <div class="pos-toolbar">
      ...
      <div class="pill"><i class="fas fa-cash-register"></i> {{if tieneSesionActiva}}Caja activa{{else}}Sin caja
        abierta{{endif tieneSesionActiva}}</div>
    </div>
  ...
  <div class="pos-grid">
    <section class="pos-card">
      ...
      <div class="search-box">
        ...
        <button type="button" class="btn btn-primary" id="btn-buscar-productos"><i class="fas fa-search"></i>
          Buscar</button>
      </div>
      ...
      <div class="search-box">
        ...
        <button type="button" class="btn btn-secondary" id="btn-buscar-clientes"><i class="fas fa-user-friends"></i>
          Buscar</button>
      </div>
      ...
      <form class="pos-form" id="cliente-rapido-form" method="post">
        ...
        <button type="submit" class="btn btn-success" style="margin-top: 0.7rem;"><i class="fas fa-plus"></i> Crear
    ...
    <section class="pos-card">
      ...
      <form class="pos-form" method="post">
        ...
        <button type="submit" class="btn btn-success" style="margin-top: 0.75rem;"><i class="fas fa-lock-open"></i>
          Abrir caja</button>
      </form>
      ...
      <form class="pos-form" method="post">
        ...
        <button type="submit" class="btn btn-secondary" style="margin-top: 0.75rem;"><i class="fas fa-lock"></i> Cerrar
          caja</button>
      </form>
      ...
      <table class="cart-table">
        ...
        <tbody id="carrito-body">
          <tr>
            <td colspan="5" class="tiny">Aún no hay productos agregados.</td>
          </tr>
        </tbody>
      </table>
      ...
      <form id="sale-form" class="pos-form" method="post" style="margin-top: 1rem;">
        ...
        <div
          style="display:flex; justify-content:space-between; align-items:center; margin-top:0.85rem; font-weight:700;">
          <span>Total:</span>
          <span id="total-venta">L. 0.00</span>
        </div>
        <button type="submit" class="btn btn-primary" style="margin-top: 0.75rem; width: 100%;"><i
            class="fas fa-check"></i> Procesar venta</button>
      </form>
    </section>
  </div>
  ...
  <section class="pos-card">
    ...
    <table class="cart-table">
      ...
      <tbody>
        ...
        {{ifnot ventasDelDia}}
        <tr>
          <td colspan="5" class="tiny">No hay ventas registradas hoy.</td>
        </tr>
